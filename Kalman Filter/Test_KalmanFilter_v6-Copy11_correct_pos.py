...
# Sample range
sample_range = np.linspace(0,5,N)
sample_range2 = np.linspace(0,1,50)
sample_range2
...
for i in range(0,N):
    ...
    measure_x_0.append(Y[0,0])
    measure_y_0.append(Y[1,0]) 
    plt.plot(Y[0,0], Y[1,0],'+', color='green')
    
# Y = np.array([[X[0,0] + abs(0.1 * np.random.randn(1)[0])],[X[1, 0] + abs(0.1 * np.random.randn(1)[0])]]) 
# plt.plot(Y[0,:], Y[1,:], color='blue')

# plt.plot(sample_range2,measure_x_0)
...
# plt.yticks((94,96,98,100,102,104,106))
# plt.yticks(np.arange(96, 106))
# plt.scatter(update_x,update_y, color='blue')
# plt.plot(measure_x,measure_y, color='blue')
# plt.scatter(measure_x,measure_y, color = 'orange')
plt.grid()
...
# plt.plot(measure_x,measure_y, color='blue')
# plt.scatter(measure_x,measure_y, color = 'orange')
plt.plot(sample_range2,measure_y)
plt.grid()

...
# #     weather = []
# #     for i in range(0,len(inputs2)):
# #         if inputs2[i][0] == 'Sunny' and inputs2[i][2] == hum_labels[j]:
# #             weather.append(inputs2[i][4])
# #         elif inputs2[i][0] == 'Rain' and inputs2[i][2] == hum_labels[j]:
# #             weather.append(inputs2[i][4])
# #         elif inputs2[i][0] == 'Overcast' and inputs2[i][2] == hum_labels[j]:
# #             weather.append(inputs2[i][4])

# #     w1[hum_labels[j]] = weather
...
#     weather = []
#     for i in range(0,len(inputs2)):
#         if inputs2[i][2] == 'Normal' and inputs2[i][2] == temp_labels[j]:
# #             weather_rain = 'rain_wind' + str(wind_labels[j])
# #             rain_1 = exec(weather_rain + '=' + str(inputs[i][4]))
# #             print(inputs2[i][4])
#             weather.append(inputs2[i][4]*learn)
...
# dec_prob = []
# for i in range(len(inputs)):
#     if inputs2[i][0] == 'Sunny':
#         if inputs2[i][2] == 'High':
#             dec_prob.append(w1_prob['High'])
#             print(w1_prob['High'])
#         elif inputs2[i][2] == 'Normal':
#             dec_prob.append(w1_prob['Normal'])
#             print(w1_prob['Normal'])
#     elif inputs2[i][0] == 'Rain':
#         if inputs2[i][2] == 'High':
#             dec_prob.append(w1_prob['High'])
#             print(w1_prob['High'])
#         elif inputs2[i][2] == 'Normal':
...
#     print(temp_labels[j])
    weather = []
    for i in range(0,len(inputs2)):
        if inputs2[i][0] == 'Rain' and inputs2[i][2] == hum_labels[j]:
#             weather_rain = 'rain_wind' + str(wind_labels[j])
#             rain_1 = exec(weather_rain + '=' + str(inputs[i][4]))
              weather.append(inputs2[i][4]*learn)
#               print("Weather: ", weather)
...
#     print(temp_labels[j])
    weather = []
    for i in range(0,len(inputs)):
        if inputs2[i][0] == 'Overcast' and inputs2[i][2] == hum_labels[j]:
#             weather_rain = 'rain_wind' + str(wind_labels[j])
#             rain_1 = exec(weather_rain + '=' + str(inputs[i][4]))
              weather.append(inputs2[i][4]*learn)
#               print("Weather: ", weather)
...
for i in range(len(inputs)):
    if inputs2[i][0] == 'Sunny':
        if inputs2[i][2] == 'High':
            dec_prob2.append(sun_hum['High'])
            print(sun_hum['High'])
        elif inputs2[i][2] == 'Normal':
            dec_prob2.append(sun_hum['Normal'])
            print(sun_hum['Normal'])
    elif inputs2[i][0] == 'Rain':
        if inputs2[i][2] == 'High':
            dec_prob2.append(rain_hum['High'])
            print(rain_hum['High'])
        elif inputs2[i][2] == 'Normal':
            dec_prob2.append(rain_hum['Normal'])
            print(rain_hum['Normal'])
    elif inputs2[i][0] == 'Overcast':
        if inputs2[i][2] == 'High':
            dec_prob2.append(overcast_hum['High'])
            print(overcast_hum['High'])
        elif inputs2[i][2] == 'Normal':
            dec_prob2.append(overcast_hum['Normal'])
            print(overcast_hum['Normal'])
#         dec_prob.append(overcast)
#         print(overcast)
dec_prob2
...
inputs3 = []
for i in range(len(df)):
    inputs3.append(Candidate(outlook[i],temp[i],humidity[i],wind[i],dec5[i]))
...
#     print(i)
    if inputs3[i][0] == 'Rain' and inputs3[i][2] == 'High':
        dec_epoch6.append(rain_wind_weak['High'])
    elif inputs3[i][0] == 'Rain' and inputs3[i][2] == 'Normal':
        dec_epoch6.append(rain_wind_weak['Normal'])
    elif inputs3[i][0] == 'Sunny' and inputs3[i][2] == 'High':
        dec_epoch6.append(rain_wind_strong['High'])
    elif inputs3[i][0] == 'Sunny' and inputs3[i][2] == 'Normal':
        dec_epoch6.append(rain_wind_strong['Normal'])
    elif inputs3[i][0] == 'Overcast' and inputs3[i][2] == 'High':
        dec_epoch6.append(rain_wind_overcast['High'])
    elif inputs3[i][0] == 'Overcast' and inputs3[i][2] == 'Normal':
        dec_epoch6.append(rain_wind_overcast['Normal'])
        
# dec_epoch6 = dec_epoch3
dec_epoch6
...
golf_dec = [dec_org,dec_prob,dec, dec_epoch2, dec_epoch3]
df_golf = pd.DataFrame(list(zip(dec_org,dec_prob,dec, dec_epoch2, dec_epoch3)))
df_golf
